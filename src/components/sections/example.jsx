...
export default function StudentDashboardProfile() {
    ...
    return (
        studentDetails && (
            <div className="m-2 rounded-2xl border p-6 flex flex-col space-y-4 overflow-auto">
                <div
                    className={`flex ${
                    ...
                    >
                        <div className="grid gap-3 grid-cols-1 md:grid-cols-2">
                            <div>
                                <Label>
                                    {
                                        studentProfileValidator.shape.fullName
                                            .description
                                    }
                                </Label>
                            ...
                            <div>
                                <Label>
                                    {
                                        studentProfileValidator.shape.contact
                                            .description
                                    }
                                </Label>
                                <Input
                            ...
                            <div>
                                <Label>
                                    {
                                        studentProfileValidator.shape.category
                                            .description
                                    }
                                </Label>
                                <Select
